[mytmlprojectsj-eb48] Operating Details
====================================

Generated On: 2024-10-28 00:04:53 UTC
...
.. important::
   ...
   **not be valid if your [mytmlprojectsj-eb48] container is NOT running**.

.. tip::
   You must have your [mytmlprojectsj-eb48] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   shubjoshi/mytmlprojectsj-eb48-amd64 (https://hub.docker.com/r/shubjoshi/mytmlprojectsj-eb48-amd64)
...
.. important::
   docker run -d -p 38451:38451 -p 58111:58111 -p 51669:51669 \-\-env TSS=0 \-\-env SOLUTIONNAME=mytmlprojectsj-eb48 \-\-env SOLUTIONDAG=solution_preprocessing_dag-mytmlprojectsj-eb48 \-\-env GITUSERNAME=joshi-shubham  \-\-env GITREPOURL=https://github.com/joshi-shubham/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=38451  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=58111  \-\-env SOLUTIONVIPERVIZPORT=51669 \-\-env DOCKERUSERNAME='shubjoshi'  \-\-env EXTERNALPORT=38193 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='shubjoshi2056@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  shubjoshi/mytmlprojectsj-eb48-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=51669
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=38451
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - shubjoshi/mytmlprojectsj-eb48-amd64
...
It can be accessed by entering: http://localhost:58111
...
.. important::
   http://localhost:51669/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:51669/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:51669/<html file>
...
[mytmlprojectsj-eb48] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/joshi-shubham/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/mytmlprojectsj-eb48
...
.. important::
   https://mytmlprojectsj-eb48.readthedocs.io
...
.. important::
   solution_preprocessing_dag-mytmlprojectsj-eb48
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=38451, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45593, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36001, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40911, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40735, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41697, HPDEHOST=127.0.1.1, HPDEPORT=41281, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36285

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-873-mytmlprojectsj-eb48,solution_preprocessing_dag-mytmlprojectsj-eb48, python-preprocess-2004-mytmlprojectsj-eb48,solution_preprocessing_dag-mytmlprojectsj-eb48, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
